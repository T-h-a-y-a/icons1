...
const DataDeduplicationServices  = () => {
  return (
    <div className="mt-4">
      <Helmet>
        <title>Global Data Deduplication Services | Optimize Now</title>
        <meta
          name="description"
          content="Professional data deduplication services to enhance data quality, reduce storage needs, and improve overall efficiency."
        />
      </Helmet>
      {/* Top Image */}
      <div className="text-left">
        <img
          src="/assets/data-dedulication-header.jpg"
          alt="Data Dedulication"
          className="w-full h-auto"
        />
      </div>
      <div className="text-center">
          <h1 className=" pt-10 playfont font-bold text-2xl">Accurate & Secure Data Deduplication Services to Ensure Clean and Reliable Data</h1>
          <p className="poppins-regular text-[#9f9f9f] text-lg md:text-[18px]  max-w-[63%] mx-auto m-6 leading-relaxed">At Icons Technologies, our Data Deduplication service focuses on improving the quality and consistency of your data by eliminating redundant or duplicate entries across your datasets. This process ensures your data is accurate, streamlined, and ready for analysis, ultimately enhancing operational efficiency and decision-making. Our services Includes</p>
      </div>
      
        <div className="max-w-6xl mx-auto p-4">
          <h3 className="playfont text-xl font-semibold text-center pb-10">Our Data Deduplication Services</h3>
      <div>
        <Maincard main={DataManagementservices.Datadeduplicationservices} />
      </div>
    </div>
...
export default DataDeduplicationServices;
